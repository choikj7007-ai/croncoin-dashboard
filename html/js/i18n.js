...
const I18N = {
    en: {
        ...
        'address.txCount': 'Transactions',
        'address.type': 'Type',
        'address.balanceAfter': 'Balance',
        'address.sent': 'Sent',
        'address.received': 'Received',
        'address.sendRecv': 'Send/Recv',
        'address.noTx': 'No transactions found',
    ...
    ko: {
        ...
        'hd.recoverXpubBtn': '마스터키(xprv)로 지갑조회',
        'hd.mnemonicInputLabel': '12단어 니모닉을 입력하세요',
        'hd.xpubInputLabel': '마스터 개인키(xprv)를 입력하세요',
        'hd.recoverBtn': '조회',
        'hd.invalidMnemonic': '유효하지 않은 니모닉입니다',
        'hd.invalidXpub': '유효하지 않은 xprv입니다',
        'hd.watchOnly': '조회 전용 (개인키 없음)',
        'hd.recovering': '조회 중...',
        'hd.recovered': '지갑이 성공적으로 복원되었습니다',
        'hd.recoveredXpub': '지갑 조회 완료',

        // Balance Check
        'bal.xpubBtn': '내 채굴지갑 조회',
        ...
        'address.transactions': '거래내역',
        'address.txCount': '거래 수',
        'address.type': '유형',
        'address.balanceAfter': '잔액',
        'address.sent': '송신',
        'address.received': '수신',
        'address.sendRecv': '송수신',
        'address.noTx': '거래내역이 없습니다',
